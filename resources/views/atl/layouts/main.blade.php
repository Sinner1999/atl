                                ...
                                <li>
                                    <a href="javascript:void(0);">
                                        <div class="media mb-0">
                                            <img class="media-object "
                                                src="{{ asset('assets/images/xs/avatar2.jpg') }}"
                                                alt="">
                                            <div class="media-body">
                        ...
                        <li class="dropdown language-menu">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item pt-2 pb-2" href="#"><img
                                        src="{{ asset('assets/images/flag/us.svg ') }}"
                                        class="w20 mr-2 rounded-circle"> US English</a>
                                <a class="dropdown-item pt-2 pb-2" href="#"><img
                                        src="{{ asset('assets/images/flag/gb.svg ') }}"
                                        class="w20 mr-2 rounded-circle"> UK English</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item pt-2 pb-2" href="#"><img
                                        src="{{ asset('assets/images/flag/russia.svg ') }}"
                                        class="w20 mr-2 rounded-circle"> Russian</a>
                                <a class="dropdown-item pt-2 pb-2" href="#"><img
                                        src="{{ asset('assets/images/flag/arabia.svg ') }}"
                                        class="w20 mr-2 rounded-circle"> Arabic</a>
                                <a class="dropdown-item pt-2 pb-2" href="#"><img
                                        src="{{ asset('assets/images/flag/france.svg ') }}"
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100"
                                            src="{{ asset('assets/images/image-gallery/7.jpg') }}"
                                            alt="First slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100"
                                            src="{{ asset('assets/images/image-gallery/8.jpg') }}"
                                            alt="Second slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100"
                                            src="{{ asset('assets/images/image-gallery/9.jpg') }}"
                                            alt="Third slide">
                                    </div>
                                </div>
            ...
            <div class="sidebar-scroll">
                ...
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu">
                        ...
                        <li><a href="../landing/index.html"><i class="icon-cursor"></i><span>Landing Page</span></a>
                        </li>
                        ...
                        <li>
                            <a href="#uiComponents" class="has-arrow"><i
                                    class="icon-diamond"></i><span>Components</span></a>
                            <ul>
                                                ...
                                                <td>
                                                    <div class="sidebar-scroll">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-right account vivify flipInY">
                                                                <li style="padding-top: 5px; padding-bottom: 5px><a><i class="icon-call-end"></i>25100</a></li>
